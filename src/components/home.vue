  ...
  mounted() {
    ...
    setInterval(()=>{
      ...
      .then(axios.spread((cs, fl)=> {
        ...
        let weather = fl.data;
        this.weathers.date = this.moment(weather.date).format("YYYY年MM月DD日");
